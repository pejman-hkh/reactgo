...
return react.Run("nav", map[string]string{`class` :`bg-gray-800`}, []string{`
		...
		`, react.Run("div", map[string]string{`class` :`flex h-16 items-center justify-between`}, []string{`
			`, react.Run("div", map[string]string{`class` :`flex items-center`}, []string{`
				...
				`, react.Run("div", map[string]string{`class` :`hidden md:block`}, []string{`
					`, react.Run("div", map[string]string{`class` :`ml-10 flex items-baseline space-x-4`}, []string{`
						...
						`, react.Run("a", map[string]string{`aria-current` :`page`,`href` :`/home`,`class` :`bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium`}, []string{`Home`}), `
						...
						`, react.Run("a", map[string]string{`class` :`text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium`,`href` :`/about`}, []string{`About`}), `
				...
				`, react.Run("div", map[string]string{`class` :`ml-4 flex items-center md:ml-6`}, []string{`
					...
					`, react.Run("div", map[string]string{`class` :`relative ml-3`}, []string{`
						`, react.Run("div", map[string]string{}, []string{`
							`, react.Run("button", map[string]string{`aria-haspopup` :`true`,`type` :`button`,`class` :`relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800`,`id` :`user-menu-button`,`aria-expanded` :`false`}, []string{`
								`, react.Run("span", map[string]string{`class` :`absolute -inset-1.5`}, []string{}), `
						...
						`, react.Run("div", map[string]string{`class` :`absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none`,`role` :`menu`,`aria-orientation` :`vertical`,`aria-labelledby` :`user-menu-button`,`tabindex` :`-1`}, []string{`
							...
							`, react.Run("a", map[string]string{`id` :`user-menu-item-0`,`href` :`#`,`class` :`block px-4 py-2 text-sm text-gray-700`,`role` :`menuitem`,`tabindex` :`-1`}, []string{`Your Profile`}), `
			...
			`, react.Run("div", map[string]string{`class` :`-mr-2 flex md:hidden`}, []string{`
				...
				`, react.Run("button", map[string]string{`class` :`relative inline-flex items-center justify-center rounded-md bg-gray-800 p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800`,`aria-controls` :`mobile-menu`,`aria-expanded` :`false`,`type` :`button`}, []string{`
					...
					`, react.Run("svg", map[string]string{`aria-hidden` :`true`,`class` :`block h-6 w-6`,`fill` :`none`,`viewBox` :`0 0 24 24`,`stroke-width` :`1.5`,`stroke` :`currentColor`}, []string{`
						`, react.Run("path", map[string]string{`d` :`M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5`,`stroke-linecap` :`round`,`stroke-linejoin` :`round`}, []string{}), `
					`}), `
	...
	`, react.Run("div", map[string]string{`id` :`mobile-menu`,`class` :`md:hidden`}, []string{`
	  ...
	  `, react.Run("div", map[string]string{`class` :`fixed inset-0 z-40 flex`}, []string{`
		...
		`, react.Run("div", map[string]string{`class` :`relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl`}, []string{`
		  ...
		  `, react.Run("div", map[string]string{`class` :`mt-2`}, []string{`
			...
			`, react.Run("comment", map[string]string{}, []string{}), `
			`, react.Run("div", map[string]string{`role` :`tabpanel`,`tabindex` :`0`,`id` :`tabs-1-panel-1`,`class` :`space-y-10 px-4 pb-8 pt-10`,`aria-labelledby` :`tabs-1-tab-1`}, []string{`
			  `, react.Run("div", map[string]string{`class` :`grid grid-cols-2 gap-x-4`}, []string{`
				`, react.Run("div", map[string]string{`class` :`group relative text-sm`}, []string{`
				  `, react.Run("div", map[string]string{`class` :`aspect-h-1 aspect-w-1 overflow-hidden rounded-lg bg-gray-100 group-hover:opacity-75`}, []string{`
					`, react.Run("img", map[string]string{`class` :`object-cover object-center`,`src` :`https://tailwindui.com/img/ecommerce-images/mega-menu-category-01.jpg`,`alt` :`Models sitting back to back, wearing Basic Tee in black and bone.`}, []string{}), `
				  `}), `
			  ...
			  `, react.Run("div", map[string]string{}, []string{`
				...
				`, react.Run("ul", map[string]string{`role` :`list`,`aria-labelledby` :`women-clothing-heading-mobile`,`class` :`mt-6 flex flex-col space-y-6`}, []string{`
				  ...
				  `}), `
				  `, react.Run("li", map[string]string{`class` :`flow-root`}, []string{`
					`, react.Run("a", map[string]string{`class` :`-m-2 block p-2 text-gray-500`,`href` :`#`}, []string{`Pants`}), `
				  `}), `
				  `, react.Run("li", map[string]string{`class` :`flow-root`}, []string{`
			  ...
			  `, react.Run("div", map[string]string{}, []string{`
				...
				`, react.Run("ul", map[string]string{`class` :`mt-6 flex flex-col space-y-6`,`role` :`list`,`aria-labelledby` :`women-accessories-heading-mobile`}, []string{`
				  ...
				  `}), `
				  `, react.Run("li", map[string]string{`class` :`flow-root`}, []string{`
					`, react.Run("a", map[string]string{`class` :`-m-2 block p-2 text-gray-500`,`href` :`#`}, []string{`Bags`}), `
				  `}), `
				  `, react.Run("li", map[string]string{`class` :`flow-root`}, []string{`
			  ...
			  `}), `
			  `, react.Run("div", map[string]string{}, []string{`
				`, react.Run("p", map[string]string{`class` :`font-medium text-gray-900`,`id` :`women-brands-heading-mobile`}, []string{`Brands`}), `
				`, react.Run("ul", map[string]string{`aria-labelledby` :`women-brands-heading-mobile`,`class` :`mt-6 flex flex-col space-y-6`,`role` :`list`}, []string{`
				  `, react.Run("li", map[string]string{`class` :`flow-root`}, []string{`
			...
			`}), `
			`, react.Run("comment", map[string]string{}, []string{}), `
			`, react.Run("div", map[string]string{`role` :`tabpanel`,`tabindex` :`0`,`id` :`tabs-1-panel-2`,`class` :`space-y-10 px-4 pb-8 pt-10`,`aria-labelledby` :`tabs-1-tab-2`}, []string{`
			  `, react.Run("div", map[string]string{`class` :`grid grid-cols-2 gap-x-4`}, []string{`
				`, react.Run("div", map[string]string{`class` :`group relative text-sm`}, []string{`
				  `, react.Run("div", map[string]string{`class` :`aspect-h-1 aspect-w-1 overflow-hidden rounded-lg bg-gray-100 group-hover:opacity-75`}, []string{`
			  ...
			  `, react.Run("div", map[string]string{}, []string{`
				...
				`, react.Run("ul", map[string]string{`aria-labelledby` :`men-brands-heading-mobile`,`class` :`mt-6 flex flex-col space-y-6`,`role` :`list`}, []string{`
				  `, react.Run("li", map[string]string{`class` :`flow-root`}, []string{`
		  ...
		  `, react.Run("div", map[string]string{`class` :`space-y-6 border-t border-gray-200 px-4 py-6`}, []string{`
			`, react.Run("div", map[string]string{`class` :`flow-root`}, []string{`
			  `, react.Run("a", map[string]string{`class` :`-m-2 block p-2 font-medium text-gray-900`,`href` :`#`}, []string{`Sign in`}), `
			`}), `
			`, react.Run("div", map[string]string{`class` :`flow-root`}, []string{`
		  ...
		  `, react.Run("div", map[string]string{`class` :`border-t border-gray-200 px-4 py-6`}, []string{`
			`, react.Run("a", map[string]string{`href` :`#`,`class` :`-m-2 flex items-center p-2`}, []string{`
			  `, react.Run("img", map[string]string{`class` :`block h-auto w-5 flex-shrink-0`,`src` :`https://tailwindui.com/img/flags/flag-canada.svg`,`alt` :``}, []string{}), `
		  ...
		  `, react.Run("div", map[string]string{`class` :`flex h-16 items-center`}, []string{`
					  ...
					  `, react.Run("div", map[string]string{`class` :`mx-auto max-w-7xl px-8`}, []string{`
						`, react.Run("div", map[string]string{`class` :`grid grid-cols-2 gap-x-8 gap-y-10 py-16`}, []string{`
						  `, react.Run("div", map[string]string{`class` :`col-start-2 grid grid-cols-2 gap-x-8`}, []string{`
							...
							`, react.Run("div", map[string]string{`class` :`group relative text-base sm:text-sm`}, []string{`
							  `, react.Run("div", map[string]string{`class` :`aspect-h-1 aspect-w-1 overflow-hidden rounded-lg bg-gray-100 group-hover:opacity-75`}, []string{`
								`, react.Run("img", map[string]string{`alt` :`Close up of Basic Tee fall bundle with off-white, ochre, olive, and black tees.`,`class` :`object-cover object-center`,`src` :`https://tailwindui.com/img/ecommerce-images/mega-menu-category-02.jpg`}, []string{}), `
							  `}), `
							  `, react.Run("a", map[string]string{`href` :`#`,`class` :`mt-6 block font-medium text-gray-900`}, []string{`
						  ...
						  `, react.Run("div", map[string]string{`class` :`row-start-1 grid grid-cols-3 gap-x-8 gap-y-10 text-sm`}, []string{`
							`, react.Run("div", map[string]string{}, []string{`
							  ...
							  `, react.Run("ul", map[string]string{`aria-labelledby` :`Clothing-heading`,`class` :`mt-6 space-y-6 sm:mt-4 sm:space-y-4`,`role` :`list`}, []string{`
								...
								`}), `
								`, react.Run("li", map[string]string{`class` :`flex`}, []string{`
								  `, react.Run("a", map[string]string{`class` :`hover:text-gray-800`,`href` :`#`}, []string{`Activewear`}), `
								`}), `
								`, react.Run("li", map[string]string{`class` :`flex`}, []string{`
							...
							`}), `
							`, react.Run("div", map[string]string{}, []string{`
							  `, react.Run("p", map[string]string{`class` :`font-medium text-gray-900`,`id` :`Accessories-heading`}, []string{`Accessories`}), `
						  ...
						  `, react.Run("div", map[string]string{`class` :`row-start-1 grid grid-cols-3 gap-x-8 gap-y-10 text-sm`}, []string{`
							`, react.Run("div", map[string]string{}, []string{`
							  ...
							  `, react.Run("ul", map[string]string{`role` :`list`,`aria-labelledby` :`Clothing-heading`,`class` :`mt-6 space-y-6 sm:mt-4 sm:space-y-4`}, []string{`
								...
								`}), `
								`, react.Run("li", map[string]string{`class` :`flex`}, []string{`
								  `, react.Run("a", map[string]string{`class` :`hover:text-gray-800`,`href` :`#`}, []string{`Browse All`}), `
								`}), `
							  `}), `
							`}), `
							`, react.Run("div", map[string]string{}, []string{`
							  `, react.Run("p", map[string]string{`class` :`font-medium text-gray-900`,`id` :`Accessories-heading`}, []string{`Accessories`}), `
							  `, react.Run("ul", map[string]string{`class` :`mt-6 space-y-6 sm:mt-4 sm:space-y-4`,`role` :`list`,`aria-labelledby` :`Accessories-heading`}, []string{`
								`, react.Run("li", map[string]string{`class` :`flex`}, []string{`
								  `, react.Run("a", map[string]string{`href` :`#`,`class` :`hover:text-gray-800`}, []string{`Watches`}), `
								`}), `
								`, react.Run("li", map[string]string{`class` :`flex`}, []string{`
								...
								`}), `
								`, react.Run("li", map[string]string{`class` :`flex`}, []string{`
								  `, react.Run("a", map[string]string{`class` :`hover:text-gray-800`,`href` :`#`}, []string{`Bags`}), `
								`}), `
								`, react.Run("li", map[string]string{`class` :`flex`}, []string{`
								  `, react.Run("a", map[string]string{`href` :`#`,`class` :`hover:text-gray-800`}, []string{`Sunglasses`}), `
								`}), `
			...
			`, react.Run("div", map[string]string{`class` :`ml-auto flex items-center`}, []string{`
			  ...
			  `, react.Run("div", map[string]string{`class` :`hidden lg:ml-8 lg:flex`}, []string{`
				`, react.Run("a", map[string]string{`class` :`flex items-center text-gray-700 hover:text-gray-800`,`href` :`#`}, []string{`
			  ...
			  `, react.Run("div", map[string]string{`class` :`ml-4 flow-root lg:ml-6`}, []string{`
				`, react.Run("a", map[string]string{`class` :`group -m-2 flex items-center p-2`,`href` :`#`}, []string{`
				  `, react.Run("svg", map[string]string{`viewBox` :`0 0 24 24`,`stroke-width` :`1.5`,`stroke` :`currentColor`,`aria-hidden` :`true`,`class` :`h-6 w-6 flex-shrink-0 text-gray-400 group-hover:text-gray-500`,`fill` :`none`}, []string{`
					`, react.Run("path", map[string]string{`d` :`M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z`,`stroke-linecap` :`round`,`stroke-linejoin` :`round`}, []string{}), `
				  `}), `
...
return react.Run("f", map[string]string{}, []string{`
	...
	`, react.Run("head", map[string]string{}, []string{`
		`, react.Run("link", map[string]string{`href` :`/assets/css/dist/main.css`,`rel` :`stylesheet`}, []string{}), `
	`}), `
	`, react.Run("Header", map[string]string{}, []string{`
	`}), `
