...
func (r Component) NavHeader(props map[string]string, childrens string) string {
return react.Run("nav", map[string]string{`class` :`bg-gray-800`}, []string{`
	`, react.Run("div", map[string]string{`class` :`mx-auto max-w-7xl px-4 sm:px-6 lg:px-8`}, []string{`
		`, react.Run("div", map[string]string{`class` :`flex h-16 items-center justify-between`}, []string{`
			`, react.Run("div", map[string]string{`class` :`flex items-center`}, []string{`
				...
				`, react.Run("div", map[string]string{`class` :`hidden md:block`}, []string{`
					`, react.Run("div", map[string]string{`class` :`ml-10 flex items-baseline space-x-4`}, []string{`
						...
						`, react.Run("a", map[string]string{`href` :`/home`,`class` :`bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium`,`aria-current` :`page`}, []string{`Home`}), `
						`, react.Run("a", map[string]string{`href` :`/login`,`class` :`text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium`}, []string{`Login`}), `
						`, react.Run("a", map[string]string{`href` :`/register`,`class` :`text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium`}, []string{`Register`}), `
						`, react.Run("a", map[string]string{`href` :`/about`,`class` :`text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium`}, []string{`About`}), `
						`, react.Run("a", map[string]string{`href` :`/contact`,`class` :`text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium`}, []string{`Contact`}), `
					`}), `
				`}), `
			`}), `
			`, react.Run("div", map[string]string{`class` :`hidden md:block`}, []string{`
				`, react.Run("div", map[string]string{`class` :`ml-4 flex items-center md:ml-6`}, []string{`
					`, react.Run("button", map[string]string{`class` :`relative rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800`,`type` :`button`}, []string{`
						...
						`, react.Run("svg", map[string]string{`aria-hidden` :`true`,`class` :`h-6 w-6`,`fill` :`none`,`viewBox` :`0 0 24 24`,`stroke-width` :`1.5`,`stroke` :`currentColor`}, []string{`
					...
					`, react.Run("div", map[string]string{`class` :`relative ml-3`}, []string{`
						`, react.Run("div", map[string]string{}, []string{`
							`, react.Run("button", map[string]string{`id` :`user-menu-button`,`aria-expanded` :`false`,`aria-haspopup` :`true`,`type` :`button`,`class` :`relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800`}, []string{`
								`, react.Run("span", map[string]string{`class` :`absolute -inset-1.5`}, []string{}), `
						...
						`, react.Run("div", map[string]string{`class` :`absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none`,`role` :`menu`,`aria-orientation` :`vertical`,`aria-labelledby` :`user-menu-button`,`tabindex` :`-1`}, []string{`
							...
							`, react.Run("a", map[string]string{`tabindex` :`-1`,`id` :`user-menu-item-0`,`href` :`#`,`class` :`block px-4 py-2 text-sm text-gray-700`,`role` :`menuitem`}, []string{`Your Profile`}), `
							`, react.Run("a", map[string]string{`href` :`#`,`class` :`block px-4 py-2 text-sm text-gray-700`,`role` :`menuitem`,`tabindex` :`-1`,`id` :`user-menu-item-1`}, []string{`Settings`}), `
							`, react.Run("a", map[string]string{`class` :`block px-4 py-2 text-sm text-gray-700`,`role` :`menuitem`,`tabindex` :`-1`,`id` :`user-menu-item-2`,`href` :`#`}, []string{`Sign out`}), `
						`}), `
					`}), `
				`}), `
			`}), `
			`, react.Run("div", map[string]string{`class` :`-mr-2 flex md:hidden`}, []string{`
				...
				`, react.Run("button", map[string]string{`class` :`relative inline-flex items-center justify-center rounded-md bg-gray-800 p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800`,`aria-controls` :`mobile-menu`,`aria-expanded` :`false`,`type` :`button`}, []string{`
					...
					`, react.Run("svg", map[string]string{`stroke` :`currentColor`,`aria-hidden` :`true`,`class` :`block h-6 w-6`,`fill` :`none`,`viewBox` :`0 0 24 24`,`stroke-width` :`1.5`}, []string{`
						`, react.Run("path", map[string]string{`stroke-linejoin` :`round`,`d` :`M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5`,`stroke-linecap` :`round`}, []string{}), `
					`}), `
	...
	`, react.Run("div", map[string]string{`class` :`md:hidden`,`id` :`mobile-menu`}, []string{`
		`, react.Run("div", map[string]string{`class` :`space-y-1 px-2 pb-3 pt-2 sm:px-3`}, []string{`
			...
			`, react.Run("a", map[string]string{`aria-current` :`page`,`href` :`#`,`class` :`bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium`}, []string{`Dashboard`}), `
			...
			`, react.Run("a", map[string]string{`class` :`text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium`,`href` :`#`}, []string{`Calendar`}), `
		...
		`, react.Run("div", map[string]string{`class` :`border-t border-gray-700 pb-3 pt-4`}, []string{`
			...
			`, react.Run("div", map[string]string{`class` :`mt-3 space-y-1 px-2`}, []string{`
				`, react.Run("a", map[string]string{`href` :`#`,`class` :`block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white`}, []string{`Your
					Profile`}), `
				`, react.Run("a", map[string]string{`class` :`block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white`,`href` :`#`}, []string{`Settings`}), `
...
return react.Run("f", map[string]string{}, []string{`
	`, react.Run("header", map[string]string{}, []string{`
		`, react.Run("div", map[string]string{`class` :``}, []string{`
			`, react.Run("NavHeader", map[string]string{}, []string{}), `
...
`, react.Run("div", map[string]string{`class` :`bg-white`}, []string{`
	`, react.Run("comment", map[string]string{}, []string{}), `
	`, react.Run("div", map[string]string{`class` :`relative z-40 lg:hidden`,`role` :`dialog`,`aria-modal` :`true`}, []string{`
	  `, react.Run("comment", map[string]string{}, []string{}), `
	  ...
	  `, react.Run("div", map[string]string{`class` :`fixed inset-0 z-40 flex`}, []string{`
		...
		`, react.Run("div", map[string]string{`class` :`relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl`}, []string{`
		  `, react.Run("div", map[string]string{`class` :`flex px-4 pb-2 pt-5`}, []string{`
			`, react.Run("button", map[string]string{`class` :`relative -m-2 inline-flex items-center justify-center rounded-md p-2 text-gray-400`,`type` :`button`}, []string{`
			  `, react.Run("span", map[string]string{`class` :`absolute -inset-0.5`}, []string{}), `
		  ...
		  `, react.Run("div", map[string]string{`class` :`mt-2`}, []string{`
			`, react.Run("div", map[string]string{`class` :`border-b border-gray-200`}, []string{`
			  `, react.Run("div", map[string]string{`class` :`-mb-px flex space-x-8 px-4`,`aria-orientation` :`horizontal`,`role` :`tablist`}, []string{`
				`, react.Run("comment", map[string]string{}, []string{}), `
				`, react.Run("button", map[string]string{`aria-controls` :`tabs-1-panel-1`,`role` :`tab`,`type` :`button`,`id` :`tabs-1-tab-1`,`class` :`border-transparent text-gray-900 flex-1 whitespace-nowrap border-b-2 px-1 py-4 text-base font-medium`}, []string{`Women`}), `
				`, react.Run("comment", map[string]string{}, []string{}), `
				`, react.Run("button", map[string]string{`id` :`tabs-1-tab-2`,`class` :`border-transparent text-gray-900 flex-1 whitespace-nowrap border-b-2 px-1 py-4 text-base font-medium`,`aria-controls` :`tabs-1-panel-2`,`role` :`tab`,`type` :`button`}, []string{`Men`}), `
			  `}), `
			`}), `
  
			`, react.Run("comment", map[string]string{}, []string{}), `
			`, react.Run("div", map[string]string{`id` :`tabs-1-panel-1`,`class` :`space-y-10 px-4 pb-8 pt-10`,`aria-labelledby` :`tabs-1-tab-1`,`role` :`tabpanel`,`tabindex` :`0`}, []string{`
			  `, react.Run("div", map[string]string{`class` :`grid grid-cols-2 gap-x-4`}, []string{`
				`, react.Run("div", map[string]string{`class` :`group relative text-sm`}, []string{`
				  `, react.Run("div", map[string]string{`class` :`aspect-h-1 aspect-w-1 overflow-hidden rounded-lg bg-gray-100 group-hover:opacity-75`}, []string{`
					`, react.Run("img", map[string]string{`alt` :`Models sitting back to back, wearing Basic Tee in black and bone.`,`class` :`object-cover object-center`,`src` :`https://tailwindui.com/img/ecommerce-images/mega-menu-category-01.jpg`}, []string{}), `
				  `}), `
				...
				`, react.Run("div", map[string]string{`class` :`group relative text-sm`}, []string{`
				  `, react.Run("div", map[string]string{`class` :`aspect-h-1 aspect-w-1 overflow-hidden rounded-lg bg-gray-100 group-hover:opacity-75`}, []string{`
					`, react.Run("img", map[string]string{`class` :`object-cover object-center`,`src` :`https://tailwindui.com/img/ecommerce-images/mega-menu-category-02.jpg`,`alt` :`Close up of Basic Tee fall bundle with off-white, ochre, olive, and black tees.`}, []string{}), `
				  `}), `
				  `, react.Run("a", map[string]string{`href` :`#`,`class` :`mt-6 block font-medium text-gray-900`}, []string{`
					`, react.Run("span", map[string]string{`class` :`absolute inset-0 z-10`,`aria-hidden` :`true`}, []string{}), `
					Basic Tees
			  ...
			  `, react.Run("div", map[string]string{}, []string{`
				...
				`, react.Run("ul", map[string]string{`role` :`list`,`aria-labelledby` :`women-clothing-heading-mobile`,`class` :`mt-6 flex flex-col space-y-6`}, []string{`
				  ...
				  `}), `
				  `, react.Run("li", map[string]string{`class` :`flow-root`}, []string{`
					`, react.Run("a", map[string]string{`class` :`-m-2 block p-2 text-gray-500`,`href` :`#`}, []string{`Activewear`}), `
				  `}), `
				  `, react.Run("li", map[string]string{`class` :`flow-root`}, []string{`
			  ...
			  `}), `
			  `, react.Run("div", map[string]string{}, []string{`
				`, react.Run("p", map[string]string{`class` :`font-medium text-gray-900`,`id` :`women-accessories-heading-mobile`}, []string{`Accessories`}), `
				`, react.Run("ul", map[string]string{`role` :`list`,`aria-labelledby` :`women-accessories-heading-mobile`,`class` :`mt-6 flex flex-col space-y-6`}, []string{`
				  `, react.Run("li", map[string]string{`class` :`flow-root`}, []string{`
				  ...
				  `}), `
				  `, react.Run("li", map[string]string{`class` :`flow-root`}, []string{`
					`, react.Run("a", map[string]string{`class` :`-m-2 block p-2 text-gray-500`,`href` :`#`}, []string{`Sunglasses`}), `
				  `}), `
				  `, react.Run("li", map[string]string{`class` :`flow-root`}, []string{`
			  ...
			  `, react.Run("div", map[string]string{}, []string{`
				...
				`, react.Run("ul", map[string]string{`role` :`list`,`aria-labelledby` :`women-brands-heading-mobile`,`class` :`mt-6 flex flex-col space-y-6`}, []string{`
				  ...
				  `}), `
				  `, react.Run("li", map[string]string{`class` :`flow-root`}, []string{`
					`, react.Run("a", map[string]string{`href` :`#`,`class` :`-m-2 block p-2 text-gray-500`}, []string{`Significant Other`}), `
				  `}), `
				`}), `
			  `}), `
			`}), `
			...
			`, react.Run("div", map[string]string{`id` :`tabs-1-panel-2`,`class` :`space-y-10 px-4 pb-8 pt-10`,`aria-labelledby` :`tabs-1-tab-2`,`role` :`tabpanel`,`tabindex` :`0`}, []string{`
			  `, react.Run("div", map[string]string{`class` :`grid grid-cols-2 gap-x-4`}, []string{`
				`, react.Run("div", map[string]string{`class` :`group relative text-sm`}, []string{`
				  `, react.Run("div", map[string]string{`class` :`aspect-h-1 aspect-w-1 overflow-hidden rounded-lg bg-gray-100 group-hover:opacity-75`}, []string{`
					`, react.Run("img", map[string]string{`alt` :`Drawstring top with elastic loop closure and textured interior padding.`,`class` :`object-cover object-center`,`src` :`https://tailwindui.com/img/ecommerce-images/product-page-04-detail-product-shot-01.jpg`}, []string{}), `
				  `}), `
				  `, react.Run("a", map[string]string{`href` :`#`,`class` :`mt-6 block font-medium text-gray-900`}, []string{`
					`, react.Run("span", map[string]string{`aria-hidden` :`true`,`class` :`absolute inset-0 z-10`}, []string{}), `
					New Arrivals
				  `}), `
				  `, react.Run("p", map[string]string{`aria-hidden` :`true`,`class` :`mt-1`}, []string{`Shop now`}), `
				`}), `
			  ...
			  `}), `
			  `, react.Run("div", map[string]string{}, []string{`
				`, react.Run("p", map[string]string{`class` :`font-medium text-gray-900`,`id` :`men-clothing-heading-mobile`}, []string{`Clothing`}), `
			  ...
			  `, react.Run("div", map[string]string{}, []string{`
				...
				`, react.Run("ul", map[string]string{`role` :`list`,`aria-labelledby` :`men-accessories-heading-mobile`,`class` :`mt-6 flex flex-col space-y-6`}, []string{`
				  `, react.Run("li", map[string]string{`class` :`flow-root`}, []string{`
					`, react.Run("a", map[string]string{`href` :`#`,`class` :`-m-2 block p-2 text-gray-500`}, []string{`Watches`}), `
				  `}), `
				  `, react.Run("li", map[string]string{`class` :`flow-root`}, []string{`
		  ...
		  `, react.Run("div", map[string]string{`class` :`space-y-6 border-t border-gray-200 px-4 py-6`}, []string{`
			...
			`}), `
			`, react.Run("div", map[string]string{`class` :`flow-root`}, []string{`
			  `, react.Run("a", map[string]string{`class` :`-m-2 block p-2 font-medium text-gray-900`,`href` :`#`}, []string{`Stores`}), `
			`}), `
		  `}), `
		  ...
		  `, react.Run("div", map[string]string{`class` :`space-y-6 border-t border-gray-200 px-4 py-6`}, []string{`
			...
			`}), `
			`, react.Run("div", map[string]string{`class` :`flow-root`}, []string{`
			  `, react.Run("a", map[string]string{`href` :`#`,`class` :`-m-2 block p-2 font-medium text-gray-900`}, []string{`Create account`}), `
			`}), `
		  `}), `
	...
	`, react.Run("header", map[string]string{`class` :`relative bg-white`}, []string{`
	  ...
	  `, react.Run("nav", map[string]string{`aria-label` :`Top`,`class` :`mx-auto max-w-7xl px-4 sm:px-6 lg:px-8`}, []string{`
		`, react.Run("div", map[string]string{`class` :`border-b border-gray-200`}, []string{`
		  `, react.Run("div", map[string]string{`class` :`flex h-16 items-center`}, []string{`
			...
			`, react.Run("div", map[string]string{`class` :`ml-4 flex lg:ml-0`}, []string{`
			  `, react.Run("a", map[string]string{`href` :`#`}, []string{`
				...
				`, react.Run("img", map[string]string{`class` :`h-8 w-auto`,`src` :`https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600`,`alt` :``}, []string{}), `
			  `}), `
			`}), `
			  ...
			  `, react.Run("div", map[string]string{`class` :`flex h-full space-x-8`}, []string{`
				`, react.Run("div", map[string]string{`class` :`flex`}, []string{`
				  `, react.Run("div", map[string]string{`class` :`relative flex`}, []string{`
					`, react.Run("comment", map[string]string{}, []string{}), `
					`, react.Run("button", map[string]string{`type` :`button`,`class` :`border-transparent text-gray-700 hover:text-gray-800 relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out`,`aria-expanded` :`false`}, []string{`Women`}), `
				  `}), `
						  ...
						  `, react.Run("div", map[string]string{`class` :`row-start-1 grid grid-cols-3 gap-x-8 gap-y-10 text-sm`}, []string{`
							`, react.Run("div", map[string]string{}, []string{`
							  ...
							  `, react.Run("ul", map[string]string{`role` :`list`,`aria-labelledby` :`Clothing-heading`,`class` :`mt-6 space-y-6 sm:mt-4 sm:space-y-4`}, []string{`
								...
								`}), `
								`, react.Run("li", map[string]string{`class` :`flex`}, []string{`
								  `, react.Run("a", map[string]string{`href` :`#`,`class` :`hover:text-gray-800`}, []string{`Dresses`}), `
								`}), `
								`, react.Run("li", map[string]string{`class` :`flex`}, []string{`
				...
				`, react.Run("div", map[string]string{`class` :`flex`}, []string{`
				  `, react.Run("div", map[string]string{`class` :`relative flex`}, []string{`
					`, react.Run("comment", map[string]string{}, []string{}), `
					`, react.Run("button", map[string]string{`type` :`button`,`class` :`border-transparent text-gray-700 hover:text-gray-800 relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out`,`aria-expanded` :`false`}, []string{`Men`}), `
				  `}), `
					  ...
					  `, react.Run("div", map[string]string{`class` :`mx-auto max-w-7xl px-8`}, []string{`
						`, react.Run("div", map[string]string{`class` :`grid grid-cols-2 gap-x-8 gap-y-10 py-16`}, []string{`
						  `, react.Run("div", map[string]string{`class` :`col-start-2 grid grid-cols-2 gap-x-8`}, []string{`
							`, react.Run("div", map[string]string{`class` :`group relative text-base sm:text-sm`}, []string{`
							  `, react.Run("div", map[string]string{`class` :`aspect-h-1 aspect-w-1 overflow-hidden rounded-lg bg-gray-100 group-hover:opacity-75`}, []string{`
								`, react.Run("img", map[string]string{`class` :`object-cover object-center`,`src` :`https://tailwindui.com/img/ecommerce-images/product-page-04-detail-product-shot-01.jpg`,`alt` :`Drawstring top with elastic loop closure and textured interior padding.`}, []string{}), `
							  `}), `
							  `, react.Run("a", map[string]string{`href` :`#`,`class` :`mt-6 block font-medium text-gray-900`}, []string{`
								`, react.Run("span", map[string]string{`class` :`absolute inset-0 z-10`,`aria-hidden` :`true`}, []string{}), `
								New Arrivals
						  ...
						  `, react.Run("div", map[string]string{`class` :`row-start-1 grid grid-cols-3 gap-x-8 gap-y-10 text-sm`}, []string{`
							`, react.Run("div", map[string]string{}, []string{`
							  ...
							  `, react.Run("ul", map[string]string{`role` :`list`,`aria-labelledby` :`Clothing-heading`,`class` :`mt-6 space-y-6 sm:mt-4 sm:space-y-4`}, []string{`
								...
								`}), `
								`, react.Run("li", map[string]string{`class` :`flex`}, []string{`
								  `, react.Run("a", map[string]string{`class` :`hover:text-gray-800`,`href` :`#`}, []string{`T-Shirts`}), `
								`}), `
								`, react.Run("li", map[string]string{`class` :`flex`}, []string{`
								  `, react.Run("a", map[string]string{`href` :`#`,`class` :`hover:text-gray-800`}, []string{`Jackets`}), `
								`}), `
							...
							`, react.Run("div", map[string]string{}, []string{`
							  ...
							  `, react.Run("ul", map[string]string{`role` :`list`,`aria-labelledby` :`Accessories-heading`,`class` :`mt-6 space-y-6 sm:mt-4 sm:space-y-4`}, []string{`
								...
								`}), `
								`, react.Run("li", map[string]string{`class` :`flex`}, []string{`
								  `, react.Run("a", map[string]string{`class` :`hover:text-gray-800`,`href` :`#`}, []string{`Wallets`}), `
								`}), `
								`, react.Run("li", map[string]string{`class` :`flex`}, []string{`
								  `, react.Run("a", map[string]string{`href` :`#`,`class` :`hover:text-gray-800`}, []string{`Bags`}), `
								`}), `
								...
								`}), `
								`, react.Run("li", map[string]string{`class` :`flex`}, []string{`
								  `, react.Run("a", map[string]string{`class` :`hover:text-gray-800`,`href` :`#`}, []string{`Belts`}), `
								`}), `
							  `}), `
							`}), `
							`, react.Run("div", map[string]string{}, []string{`
							  ...
							  `, react.Run("ul", map[string]string{`role` :`list`,`aria-labelledby` :`Brands-heading`,`class` :`mt-6 space-y-6 sm:mt-4 sm:space-y-4`}, []string{`
								`, react.Run("li", map[string]string{`class` :`flex`}, []string{`
								  `, react.Run("a", map[string]string{`class` :`hover:text-gray-800`,`href` :`#`}, []string{`Re-Arranged`}), `
								`}), `
								`, react.Run("li", map[string]string{`class` :`flex`}, []string{`
								  `, react.Run("a", map[string]string{`class` :`hover:text-gray-800`,`href` :`#`}, []string{`Counterfeit`}), `
								`}), `
								`, react.Run("li", map[string]string{`class` :`flex`}, []string{`
								  `, react.Run("a", map[string]string{`href` :`#`,`class` :`hover:text-gray-800`}, []string{`Full Nelson`}), `
								`}), `
			...
			`, react.Run("div", map[string]string{`class` :`ml-auto flex items-center`}, []string{`
			  ...
			  `, react.Run("div", map[string]string{`class` :`flex lg:ml-6`}, []string{`
				`, react.Run("a", map[string]string{`class` :`p-2 text-gray-400 hover:text-gray-500`,`href` :`#`}, []string{`
			  ...
			  `, react.Run("div", map[string]string{`class` :`ml-4 flow-root lg:ml-6`}, []string{`
				`, react.Run("a", map[string]string{`href` :`#`,`class` :`group -m-2 flex items-center p-2`}, []string{`
				  `, react.Run("svg", map[string]string{`aria-hidden` :`true`,`class` :`h-6 w-6 flex-shrink-0 text-gray-400 group-hover:text-gray-500`,`fill` :`none`,`viewBox` :`0 0 24 24`,`stroke-width` :`1.5`,`stroke` :`currentColor`}, []string{`
